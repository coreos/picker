...
CoreOS projects written in Rust follow the set of style guidelines that upstream has agreed upon. Please follow them when working on your contributions by using the [rustfmt](https://crates.io/crates/rustfmt/) utility.
